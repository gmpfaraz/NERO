  ...
  return (
    <NeroLayout sidebarItems={sidebarItems}>
      <Routes>
        ...
        <Route path="*" element={<Navigate to="/nero/admin" replace />} />
      </Routes>
    </NeroLayout>
  );
};

export default NeroAdminDashboard;
